...
console.log(calcularDiferenciaDias(fecha1, fecha2));    // 0

console.log();

let fecha3 = new Date(2019, 1, 1, 1, 2);
let fecha4 = new Date(2019, 1, 1, 2, 2);
console.log(calcularDiferenciaDias(fecha3, fecha4)); // 0

console.log();

let fecha5 = new Date(2019, 1, 1, 1, 2);
let fecha6 = new Date(2019, 1, 1, 23, 2);
console.log(calcularDiferenciaDias(fecha5, fecha6)); // 1

console.log();

let fecha7 = new Date(2019, 1, 1, 1, 2);
let fecha8 = new Date(2019, 1, 28, 23, 2);
console.log(calcularDiferenciaDias(fecha7, fecha8));    // 28

console.log();

let fecha9 = new Date(2019, 1, 1);
let fecha10 = new Date(2019, 1, 28);
console.log(calcularDiferenciaDias(fecha9, fecha10));    // 27
